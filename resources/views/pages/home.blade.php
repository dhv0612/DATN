                        ...
                        <div class="aa-advance-search-top">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="aa-single-advance-search" style="width: 90% !important">
                                        <input type="text" id='message' name="title"
                                            placeholder="Nhập vào công việc bạn muốn tìm">
                                    </div>
                                    <span style="padding: 5px; ">
                                <button id='btnTalk' type="button" style="border: none"><i class="fas fa-microphone-alt"
