                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="file" required class="custom-file-input" accept=".xlsx"
                                                    id="exampleInputFile">
                                                <label class="custom-file-label" for="exampleInputFile">Chọn tệp câu hỏi</label>
                                            </div>
                                            <div class="input-group-append">
                                                <input type="submit" class="input-group-text" value="Tải lên" name="import_csv">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 20px">
                                                    <a href="{{ URL::to('/edit-question/' . $ql->Ma_cau_hoi) }}"> <i
                                                            class="fas fa-edit"
                                                            style="color: blue; margin: 0 5px;"></i></a>||
                                                    <a href="{{ URL::to('/delete-question/' . $ql->Ma_cau_hoi) }}"
                                                        onclick="return confirm('Do you want delete ?')"> <i
                                                            class="fas fa-trash-alt"
                                                            style="color: red;margin: 0 5px;"></i></a>
                                                </td>
                                            </tr>                                
                                        @endforeach
                                    </tbody>                            
