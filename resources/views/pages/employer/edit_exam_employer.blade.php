                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ URL::to('/update-exam-employer/' . $exam_detail->Ma_bai_kiem_tra) }}"
                                method="post">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" required name="mark"
                                            value="{{ $exam_detail->Diem_toi_thieu }}" class="form-control"
                                            id="exampleInputPassword1" placeholder="Nhập điểm tối thiểu">
                                    </div>
                                    <div class="form-group">
